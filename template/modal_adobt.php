            ...
            <div class="modal-body" style="padding:0 35px 35px 35px !important;">
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div id="front_img" class="d-flex align-items-end">
                            <p class="farmer-name bg-white ps-2 pe-1 py-1">🌱Farmer: <a href="#">I wayan pande putra yudha</a></p>
                        </div>
                    </div>
                        ...
                        <form id="StartAdopsiTanaman" role="POST">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p id="lokasiTanaman" style="text-shadow:none; font-family:Roboto; word-wrap: break-word; width:80px;font-style: normal;font-weight: bold;font-size: 12px;line-height: 14px;color: #12491E;">Sesetan Beach</p>
                                </div>
                                <div id="all_but_adopt" class="input-group mb-3" style="margin-left:10px; width:250px !important">
    ...
    $('#btnDoAdopt').on('click', function() {
        ...
        if (localStorage.getItem("dataAdopter") === null) {
            if (window.confirm('Before you adopt plants you must sign up first')) {
                var myModal = new bootstrap.Modal(document.getElementById('modal_signin'), {
                    keyboard: false
                })
                var myModal2 = new bootstrap.Modal(document.getElementById('modal_adobt'), {
                    keyboard: false
                })
                myModal.show()
            }
