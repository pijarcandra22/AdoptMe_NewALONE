<html lang="en">
    ...
    <div class="modal fade" id="modal_adobt" tabindex="-1" aria-labelledby="modal_signin" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1000px; border-radius:10px">
            <div class="modal-content" id="back_img" style="box-shadow: 10px 0px 30px rgba(0, 0, 0, 0.5); background-size:cover; border:none">
                ...
                <div class="modal-body" style="padding:0 35px 35px 35px !important;">
                    <div class="row">
                        <div class="col-4">
                            <div id="front_img" style="width: 100%; height: 440px; box-shadow: 10px 0px 30px rgba(0, 0, 0, 0.5); border-radius:10px"></div>
                        </div>
                        <div class="col-8">
