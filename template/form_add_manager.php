    ...
    <div class="row">
            ...
            <div class="form_add">
                ...
                <form role="form">
                    ...
                    <div style="display: flex; margin-top:8px">
                        <input id="manager_pass" class="form-control" type="text" placeholder="Manager Password">
                        <button id="addmanager-but" type="button" style="margin-left: 8px; font-family:Roboto; font-weight:bold" class="btn btn-success">UPLOAD</button>
                    </div>
                </form>
            </div>
        ...
        <div class="col-7">
            <div style="display: flex; margin-bottom:10px">
                <h3 style="margin-top:14px; color:#12491E; margin-right:10px">Manager List</h3>
